package study.kotlin.springwebflux.book
...
class BookService {
    ...
    val books = mutableListOf(
        Book(id = nextId.incrementAndGet(), name = "코틀린 인 액션", price = 3000),
        Book(id = nextId.incrementAndGet(), name = "HTTP 완벽 가이드", price = 4000),
    )
